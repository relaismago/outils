...
//   $Revision: 1.2 $                      $Date: 2005/11/24 13:19:49 $
//\/////
//\mini
////////
// PRE-INIT
...
////////
if (typeof olInfo == 'undefined' || typeof olInfo.meets == 'undefined' || !olInfo.meets(4.10)) alert('overLIB 4.10 or later is required for the Debug Plugin EXCLUSIVE.');
else {
