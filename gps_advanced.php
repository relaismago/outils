...
include_once("gps_advanced_db.php");
include_once("gps_advanced_js.php");
...
function init_gps()
{
	...
	echo "<form name='form_gps_advanced' action='gps_advanced.php'>";
														...
														)
{
	...
	echo "<input type='button' value='Reset' onClick='JavaScript=document.location.href=\"gps_advanced.php\"'><br><br>";
