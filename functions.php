...
#Normalement dans inc_initdata on devrait faire un require_once de la connexion pour être sûr qu'elle est faite. Impossible visiblement, cela provoque une erreur (pas le droit d'accéder à ../../inc_connect.php)
