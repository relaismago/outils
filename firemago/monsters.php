...
for ( $i = 0; $i < $nbMonsters; $i++ )
{
	...
	if ( $_SESSION['AuthGuilde'] == 450 ) 
	{
    	...
    	if ( mysql_num_rows($result2) > 0 ) 
		{
      		...
      		$txtmonster .= " appartient ра $nom_troll";
	...
	if ($tab_cdm_mh)
	{
		...
		$titre = "cdm recoupщes du monstre au ".$tab_cdm_mh[$last_cdm]['date_cdm'];
		...
		{
			$pdv = "> ра ".$tab_cdm_mh[$last_cdm]['pdvmin_cdm']." (bestiaire : ".$caracs_moyennes[pdv].")";
		...
		{
			$att = "> ра ".$tab_cdm_mh[$last_cdm]['attmin_cdm']." (bestiaire : ".$caracs_moyennes[att].")";
		}
		...
		{
			$esq = "> ра ".$tab_cdm_mh[$last_cdm]['esqmin_cdm']." (bestiaire : ".$caracs_moyennes[esq].")";
		}
		...
		{
			$deg = "> ра ".$tab_cdm_mh[$last_cdm]['degmin_cdm']." (bestiaire : ".$caracs_moyennes[deg].")";
		}
		...
		{
			$reg = "> ра ".$tab_cdm_mh[$last_cdm]['regmin_cdm']." (bestiaire : ".$caracs_moyennes[reg].")";
		}
		...
		{
			$arm = "> ра ".$tab_cdm_mh[$last_cdm]['armmin_cdm']." (bestiaire : ".$caracs_moyennes[arm].")";
		}
		...
		{
			$vue = "> ра ".$tab_cdm_mh[$last_cdm]['vuemin_cdm']." (bestiaire : ".$caracs_moyennes[vue].")";
		}
		...
		else
		{
			...
			{
				$mm = "> ра ".$tab_cdm_mh[$last_cdm]['mmmin_cdm'];
			}
		...
		else
		{
			...
			{
				$rm = "> ра ".$tab_cdm_mh[$last_cdm]['rmmin_cdm'];
			}
		...
		else
		{
			...
			{
				$dla = "> ра ".$tab_cdm_mh[$last_cdm]['dlamin_cdm'];
			}
