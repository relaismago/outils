...
try {
	...
	/*anchorTitle.appendChild ( document.createTextNode ( 'Plier' ) );
	anchorTitle.appendChild ( newCheckbox ( 'deltabmonster', 'toggleTableau(5)' ) );*/
...
function colorMonsters()
{
 ...
 text += "<tr><td width='15%' bgcolor='" + colorCdm + "'>&nbsp;</td><td>Vite, fais nous une CdM de la bête !</td></tr>";
...
function colorTrolls()
{
  ...
  text += "<tr><td width='15%' bgcolor='" + colorAlly + "'>&nbsp;</td><td>Un allié de la guilde !</td></tr>";
  text += "</table>";
	return text;
}
