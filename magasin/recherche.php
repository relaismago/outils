...
if (isset($HTTP_POST_VARS['criteres'])) {
	...
	//affichage ou non des compos/champis
	if (isset($HTTP_POST_VARS['compo']) && $HTTP_POST_VARS['compo']=="1")
		$modele->isCompo = 1;
	else
		$modele->isCompo = 0;

	//affichage ou non des potions/parchemins
	...
	//critères simples : id, type, tanière
	...
	//état du trésor : bloqué, réservé, confirmé, en vente
...
<table class='mh_tdborder' cellspacing="0" width="90%" align="center">
	<tr class='mh_tdpage'>
		...
		</td><td style="align:center;" width="33%">
