...
function addSubItem(idParent, text, hint, location, linktarget)
{
	...
	if (HTMLstr.indexOf(Lookup) == -1)
	{
		...
		{
			MENUitem += "\n";
			MENUitem += "<layer id='"+idParent+"submenu' visibility=hide bgcolor='"+menucolorItem+"'>\n";
			MENUitem += "<table class='mh_tdborder' width="+this.subMenuPaneWidth+">\n";
			//border='"+this.subMenuPaneBorder+"' bgcolor='"+menucolorItem+"' width="+this.subMenuPaneWidth+">\n";
		...
		if (ie||ns6)
		{
			...
			MENUitem += "<table class='mh_tdborder' width="+this.subMenuPaneWidth+">\n";
			//MENUitem += "<table border='"+this.subMenuPaneBorder+"' bgcolor='"+menucolorItem+"' width="+this.subMenuPaneWidth+">\n";
			MENUitem += "<!-- NEXT ITEM OF SUB MENU "+ idParent +" -->\n";
			MENUitem += "</table>\n";
			MENUitem += "</div>\n";
			MENUitem += "\n";
	...
	Lookup = "<!-- NEXT ITEM OF SUB MENU "+ idParent +" -->\n";
	if (n)  MENUitem = "<tr><td class='mh_tdpage' onmouseover=\"bgColor=\'"+menucolorOver+"\'\" onmouseout=\"bgColor=\'"+menucolorItem+"\'\"><a class=clsMenuItemNS title='"+hint+"' href='"+location+"' target='"+linktarget+"'>"+text+"</a><br></td></tr>\n";
	if (ie||ns6) MENUitem = "<tr><td class='mh_tdpage' onmouseover=\"bgColor=\'"+menucolorOver+"\'\" onmouseout=\"bgColor=\'"+menucolorItem+"\'\"><a class=clsMenuItemIE title='"+hint+"' href='"+location+"' target='"+linktarget+"'>"+text+"</a><br></td></tr>\n";
	MENUitem += Lookup;
