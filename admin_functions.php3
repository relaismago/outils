...
{
	include_once("gps_advanced_js.php3"); // pour la fonction swap
...
function afficherListeBaronniesCadreBaronnie($baronnie)
{
	...
	$lien_gps  = "href='gps_advanced.php3?x=$baronnie[x_trone_baronnie]&y=$baronnie[y_trone_baronnie]";
	...
	for($i=1;$i<=$nbTrolls;$i++) {
		...
		$lien_gps_adv = "href='gps_advanced.php3?swap_affutage=block&";
...
function afficherListeTrollsBaronnie($id_baronnie)
{
	...
	for($i=1;$i<=$nbTrolls;$i++) {
		...
		$lien_vue2d = "href='cockpit.php?centrer=on&cX=$res[x_troll]&cY=$res[y_troll]&cZ=$res[z_troll]'";
		$lien_gps_adv = "href='gps_advanced.php3?taille_map=600&vue=40&x=$res[x_troll]&y=$res[y_troll]'";
...
function afficherListeTrolls($sort)
{
	...
	//echo "<a href='admin.php3?troll=all'>Afficher tous les trolls</a> - ";
	?>
...
function afficherListeGowaps($id_troll)
{
	...
	for($i=1;$i<=$nbGowaps;$i++) {
		...
		$lien_gps_adv = "href='gps_advanced.php3?taille_map=600&vue=40&x=$res[x_monstre]&y=$res[y_monstre]'";
...
function afficherListeTanieres($id_troll)
{
	...
	for($i=1;$i<=$nbTanieres;$i++) {
		...
		$lien_gps_adv = "href='gps_advanced.php3?taille_map=600&vue=40&x=$res[x_lieu]&y=$res[y_lieu]&";
...
?><br>
   <table  border='0' cellpadding='0' cellspacing='2' class='mh_tdborder' align='center'width='100%'>
	...
	for($i=1;$i<=$nbChampignons;$i++) {
		...
		$lien_gps_adv = "href='gps_advanced.php3?taille_map=600&vue=40&x=$res[x_champi]&y=$res[y_champi]'";
