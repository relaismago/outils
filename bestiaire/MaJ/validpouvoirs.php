...
if( ($Pouvoir!="") && ($Template!="")){
  print("<html>");
  print("<head>");
  print("<title>Insertion d'un nouveau pouvoir</title>");
  ...
  $sql="INSERT INTO pouvoirs(Nom,Pouvoir,Descript,MM,Duree,Auto,Zone,source) VALUES(\"".$Template."\",\"".$Pouvoir."\",\"".$Descript."\",\"".$MM."\",\"".$Duree."\",\"".$Auto."\",\"".$Zone."\",\"".$Source."\");";
  if(!mysql_query($sql,$db_bestiaire)){
    die("l'insertion du nouveau pouvoir a échoué<br>$sql<br>");
  }
  else{
    print("$Template/$Pouvoir/$Descript/$MM/$Duree/$Auto/$Zone/$Source<br>");
  }
  print("</body>");
  print("</html>");
