...
if( ($Pouvoir!="") && ($Template!="")){
  ...
  print(" <form name=\"form_pouvoir\" method=\"POST\" action=\"validpouvoirs.php\">");
  ...
  print(" <caption>		 ");
  print("    <font color=\"#FFFFFF\" size=\"+1\"><b><em>Confirmez vous ce nouveau pouvoir magique ?</em></b></font>");
  print(" </caption>");
  print(" <tr align=\"center\">");
  print("   <th align=\"center\" width=32 bgcolor=\"#18D5BD\">Pouvoir</th>");
  print("   <th colspan=3 align=\"center\" width=96 bgcolor=\"#18D5BD\">Description</th>");
  print(" </tr>");
  print(" <tr align=\"center\">");
  print("   <th bgcolor=\"#B7B7DB\">");
  print("     <input name=\"Pouvoir\" width=64 size=32 READONLY value=\"$Pouvoir\"/></th>");
  print("   <th colspan=3 bgcolor=\"#B7B7DB\">");
  ...
  print("   <th align=\"center\" bgcolor=\"#18D5BD\">Séparé de l'attaque</th>");
  ...
  print(" </table>");
  print(" <p>&nbsp;</p>");							  
  print("<form name=\"valid_pouvoir\" action=\"validpouvoirs.php\" method=\"POST\" >");
  ...
  print("<INPUT TYPE=hidden NAME=\"Auto\" VALUE=\"$Auto\"></INPUT>");
