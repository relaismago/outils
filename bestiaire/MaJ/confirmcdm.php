...
$Monstre = stripslashes($_GET['Monstre']);
$Age = stripslashes($_GET['Age']);
$Nom = stripslashes($_GET['Nom']);
$Race = stripslashes($_GET['Race']);
$Famille = stripslashes($_GET['Famille']);
$Niv = stripslashes($_GET['Niv']);
$Pdv = stripslashes($_GET['Pdv']);
$Att = stripslashes($_GET['Att']);
$Esq = stripslashes($_GET['Esq']);
$Deg = stripslashes($_GET['Deg']);
$Reg = stripslashes($_GET['Reg']);
$Arm = stripslashes($_GET['Arm']);
$Vue = stripslashes($_GET['Vue']);
$Date = stripslashes($_GET['Date']);
$DateSql = stripslashes($_GET['DateSql']);
$Src = stripslashes($_GET['Src']);
$Cap = stripslashes($_GET['Cap']);
$Aff = stripslashes($_GET['Aff']);
